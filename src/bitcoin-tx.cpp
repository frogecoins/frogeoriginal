...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s froge-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  froge-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded froge transaction") + "\n" +
              "  froge-tx [options] -create [commands]   " + _("Create hex-encoded froge transaction") + "\n" +
              "\n";

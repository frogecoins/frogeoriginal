...
const char * const BITCOIN_CONF_FILENAME = "froge.conf";
const char * const BITCOIN_PID_FILENAME = "froge.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Froge";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Froge";
#else
    // Unix
    return pathRet / ".froge";
#endif
#endif
}

...
#if defined(NDEBUG)
# error "Froge cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Froge Signed Message:\n";
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Froge: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.

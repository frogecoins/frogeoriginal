...
{
    const char* pszTimestamp = "The Froge says croak on May 24 2024";
...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xd8bdb9ef7a2c7f8016519a3d0548e8a48b3437b661377ec316c9af1d5a6dd195"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xd8bdb9ef7a2c7f8016519a3d0548e8a48b3437b661377ec316c9af1d5a6dd195"))
        ...
        chainTxData = ChainTxData{
            ...
            1716570996, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1716570996, 970071, 0x1e0ffff0, 1, 42 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc33348eea704abe08f573264eef190bbcad951b87fd7247141ec9099d27fb307"));
        assert(genesis.hashMerkleRoot == uint256S("0xbff42b7112898bd83678932a6cb3646da3023755557d771424c421be36eff36b"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("172.233.214.164", "172.233.214.164"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.froge.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xc33348eea704abe08f573264eef190bbcad951b87fd7247141ec9099d27fb307")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1716570996, 0, 0x207fffff, 1, 42 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2379b9114e325beab28a1394e2c19eb7ac13644fc0047c6c60cdbe6e7f97e3a2"));
        assert(genesis.hashMerkleRoot == uint256S("0xbff42b7112898bd83678932a6cb3646da3023755557d771424c421be36eff36b"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x2379b9114e325beab28a1394e2c19eb7ac13644fc0047c6c60cdbe6e7f97e3a2"))
        };
